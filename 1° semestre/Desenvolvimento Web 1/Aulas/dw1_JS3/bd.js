// arquivo que o prof enviou, comentar e usar para fazer a atividade


function local(){ // mesma coisa q o InsereDados
...
function logon(){  // essa função checa o login
...
function logado(){ // função que mostra os dados do usuario
...
function logaout(){ // função para deslogar
...
function adicionar() { // create, msm função do inserir
 ...
 function buscar() { // read, o msm q localizar
...
function atualizar() { // update
 ...
 function apagarItemVetor() { // apaga 1 item da tabela
...
function apagaTudo(){ // apaga tudo uai
  localStorage.removeItem("tds")
}

function limpar(){ // limpa os campos de digitação
